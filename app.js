...
const { autoDeactivateCourses, notifyTeachersAboutEndingCourses, cleanOldUnavailabilityDates, sendNotificationsForAllCourses } = require("./controllers/teacherController.js");
...
app.use("/uploads", express.static("uploads/course"));
app.use("/uploads", express.static("uploads/profiles"));
app.use("/uploads", express.static("uploads/subcategory"));
app.use("/uploads", express.static("uploads/teacherDocument"));
...
cron.schedule("* * * * *", () => {
  console.log("Checking for courses to send notifications...");
