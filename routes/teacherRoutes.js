...
teacherRoutes.route("/sendNotificationsForAllCourses").get(sendNotificationsForAllCourses);
...
teacherRoutes.route("/updateTeacherDocuments").post(protect, Authorization(["teacher"]), updateTeacherDocuments);
teacherRoutes.route("/updateAadhaarImages").post(protect, Authorization(["teacher"]), updateAadhaarImages);
teacherRoutes.route("/updateVerifyStatus").post(protect, Authorization(["teacher"]), updateVerifyStatus);
